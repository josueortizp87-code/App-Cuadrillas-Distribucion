...
/// =====================
// ⚠️ REEMPLAZA ESTO
const supabaseUrl = "https://yyglybdaesasoxnhzobk.supabase.co/rest/v1/";
const supabaseKey = "sb_publishable_ayBzfA9rsXFHMQKOHKol6A_T8Nwm0KT";
...
/// 📤 GUARDAR EN SUPABASE
/// =====================
async function guardarPodaSupabase() {
    ...
    const datos = {
        ...
        hora_ini: document.getElementById('h-ini').value,
        ...
        supervisor: document.getElementById('resp-super').value,
        contratista: document.getElementById('resp-activ').value,
...
async function generarPDFPoda() {
    ...
    doc.text(`TRABAJO: Brecha ${document.getElementById('m-brecha').value}m, Poda ${document.getElementById('m-poda').value}m, Postes ${document.getElementById('m-postes').value}`, 15, 38);
    ...
    doc.text(`RESP: Super. ${document.getElementById('resp-super').value}, Contr. ${document.getElementById('resp-activ').value}`, 15, 48);
    ...
    const idsPersonal = [
        {id:'f-id-f', t:'IDENTIDAD FRENTE'},
        {id:'f-id-r', t:'IDENTIDAD REVÉS'}
    ];
    ...
    // ✅ GUARDAR EN SUPABASE (AGREGADO)
    await guardarPodaSupabase();
